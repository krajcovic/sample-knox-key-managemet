...
/**
 * This BroadcastReceiver handles KLM activation results. It has to be registered in manifest file
 * like so:
 * <p>
 * <pre>
 *     <code>
 *      <receiver android:name=".MonetLicenseReceiver">
 *          <intent-filter>*
...
public class MonetLicenseReceiver extends BroadcastReceiver {
        ...
        if (intent == null) {
            ...
            if (action == null) {
                ...
                if (errorCode == KnoxEnterpriseLicenseManager.ERROR_NONE) {
                    ...
                    Log.d("MonetLicenseReceiver", context.getString(R.string
                            .klm_activated_succesfully));
                    return;
                } else {
                    // activation failed
                    switch (errorCode) {
                        ...
                        default:
                            ...
                            Log.d("MonetLicenseReceiver", msg);
                            return;
                    }

                    // Display error message
                    showToast(context, msg_res);
                    Log.d("MonetLicenseReceiver", context.getString(msg_res));
                    return;
                }
            }
        }
